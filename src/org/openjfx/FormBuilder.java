...
public class FormBuilder {
    ...
    protected static Form buildSongAttributesForm() {
        ...
        newForm = Form.of(
                Group.of(
                        ...
                        Field.ofSingleSelectionType(AttributeRegistry.getInstance().getValues("LEAD_SING"))
                                ...
                                .valueDescription("Please enter gender of Lead Vocalist."),
    ...
    protected static Form buildChordAttributesForm() {
    ...
    protected static Form buildToplineAttributesForm() {
        return Form.of(
                Group.of(
    ...
    protected static Form buildLyricAttributesForm() {
        return Form.of(
                Group.of(
                        Field.ofStringType("")
                                .multiline(true)
